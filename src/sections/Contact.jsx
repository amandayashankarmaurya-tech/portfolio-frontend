        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              I’m a Full Stack Developer based in Lucknow, India.  
              Open to freelance, full-time roles, and exciting projects.
            </p>
          ...
          {/* Contact Form */}
          <form className="bg-amber-100 p-8 rounded-2xl shadow-md space-y-6" onSubmit={handleSubmit}>
            <div>
